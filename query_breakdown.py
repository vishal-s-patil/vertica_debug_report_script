...
def query_breakdown(client_breakdown, granularity, query_pattern, query_breakdown_chars, case_sensitive, num_items, duration, issue_time):
    ...
    aggregations = "left(query,20), count(1),(min(query_duration_us)/1000000)::numeric(10,2) min_secs,(max(query_duration_us)/1000000)::numeric(10,2) max_secs,(avg(query_duration_us)/1000000)::numeric(10,2) avg_secs"
    ...
    if granularity and not client_breakdown and not query_breakdown_chars:
        ...
        d["dimension_replacements"] = granularity_dimension + ', ' + client_breakdown_dimension
